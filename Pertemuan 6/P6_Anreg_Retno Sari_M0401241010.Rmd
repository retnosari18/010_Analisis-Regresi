...
```{r}
dt <- read_xlsx("C:\\Users\\retno\\Documents\\MATERI KULIAH\\Semester 4\\ANALISIS REGRESI\\Anreg\\Data6.xlsx")
dt # menampilkan data
```
...
Persamaan yang terbentuk adalah $$\hat{PPM}=2.8566−0.2622IPM−0.1350RLS+0.5495PBH+0.0007PDRB+0.3413PKB$$
